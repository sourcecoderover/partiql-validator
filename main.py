...
# filter_expression_1 = "SELECT col1, col2 FROM table1 WHERE col3 > 100 AND col4 IN " \
#                       "(SELECT col5 FROM table2 WHERE col6 = 'value') AND col5 < 100 ORDER BY col3 DESC;"
# filter_expression_2 = "SELECT col1, col2 FROM table1 WHERE  col5 < 100 AND col4 IN " \
#                       "(SELECT col5 FROM table2 WHERE col6 = 'value') AND col3 > 100 ORDER BY col3 DESC;"
...
normalized_sql2 = df_row_level_filter_1.get_normalized_expression()
